...
public class ApplyEntity {
    ...
    public ApplyEntity(Integer applyId, Integer applyNum, Integer applyDay, String applyReason, Integer applyStatus, LocalDateTime applyDatetime, String reviewComments, LocalDateTime reviewDatetime, Integer userId, UserEntity userEntity) {
